...
{
 var name=document.getElementById("nama_kategori_khas"+id).innerHTML;


 document.getElementById("nama_kategori_khas"+id).innerHTML="<input type='text' id='name_val"+id+"' value='"+name+"'>";
...
function save_row(id)
{
 ...
 ({
  type:'post',
  url:'control/modify.master.php',
  data:{
   edit_row:'edit_row',
   nama_kategori_khas:name,
   row_id:id
  ...
  success:function(response) {
   if(response=="success")
   {
    document.getElementById("nama_kategori_khas"+id).innerHTML=name;
