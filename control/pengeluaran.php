<?php
     ...
     if($_POST['date'] != '' && $_POST['pengeluaran'] !='' && $_POST['id_kategori_khas'] !='' && $_POST['keterangan'] !=''  ){
         ...
         mysqli_query($con, "insert into arus_khas (kredit, id_subkategori_khas, keterangan, dt, dtime) values ('$pengeluran','$id_kategori_khas','$keterangan','$dt','$datetime') ");
         echo "<div class='alert alert-success alert-dismissible'> data berhasil dimasukan  </div>";
         echo " <script type='text/javascript'> window.location.href = './biaya.aspx' </script>";
