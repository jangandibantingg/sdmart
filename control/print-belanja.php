...
<tbody>
<?php
$t=mysqli_query($con, "select orders.clear, orders.id_order, item.nama_item, item.price, orders.qty, orders.kode_item, item.kode_item, orders.dt from orders,item where item.kode_item=orders.kode_item and clear='N' order by orders.id_order desc");
...
<tr>
<td></td><td> <strong class="text-info"></strong></td>
<td align="right"><b class="text-success" id="totalchart"></td>
...
<tr>
<td></td><td > <strong class="text-info">  </td><td>  </td>
</tr>
